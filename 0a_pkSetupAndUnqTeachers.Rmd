...
some_packages <- c('tibble', 'dplyr', 'tidyr', 'readr', 'stringr', 'forcats', 'purrr', 'rmarkdown','lubridate',  'openxlsx',  'readxl')

# 'utilities', 'janitor', 'writexl', kept giving error
# installed both 'janitor' and 'writexl'
...
labValues <- read_excel("O://Transfer Files//Data_Output_2023-24//PreK Seats Dashboard//LP 2023-2024 PreK Programs by Campus.xlsx", sheet = "labValuesv1")
...
mastSched = read_csv("O:/Transfer Files/Data_Output_2023-24/PreK Seats Dashboard/1 Source Files/master_catalog_with_counts_2024_0418.csv") |> as_tibble() |>
...
write_excel_csv(temp6a,
  paste0(print_wd,"2023_1117_campusPkTorMatrix_KEN.csv"),
  na = "",
  append = FALSE,
  col_names = TRUE,
  quote = "needed",
