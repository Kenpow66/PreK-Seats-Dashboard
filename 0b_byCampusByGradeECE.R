...
# Load packages from 00_setup

lapply(some_packages, library, character.only = TRUE)

# Copy over and load up the useful docs ----
# budgeted <- read_excel("O:/Transfer Files/Data_Output_2023-24/Chief Hole Leveling Sept/1 Source Files/PLAIN sent to area offices Forecast_Feb2023.xlsx", sheet = "perSchPerGrade")

# Today's Day-end CSV of Enrollment ----
# Waffle > SharePoint > DSV > Documents > Campus Enrollment Report > Source Data > SIS > export_MMDDYYYY_Cleaned.xlsx

 # rm(list = ls(pattern = "^temp"))

file.copy("C:/Users/lprice5/Downloads/export_11-17-2023_Cleaned.xlsx",
          "O:/Transfer Files/Data_Output_2023-24/PreK Seats Dashboard/1 Source Files/export_11-17-2023_Cleaned.xlsx", overwrite = FALSE, copy.date = TRUE)

today0 <- read_excel("O:/Transfer Files/Data_Output_2023-24/PreK Seats Dashboard/1 Source Files/export_11-17-2023_Cleaned.xlsx")
...
write_excel_csv(todayECE,
  paste0(print_wd,"2023_1117_eceEnrollment.csv"),
  na = "",
  append = FALSE,
  col_names = TRUE,
  quote = "needed",
...
write_excel_csv(todayECEwide,
  paste0(print_wd,"2023_1117_eceTopline.csv"),
  na = "",
  append = FALSE,
  col_names = TRUE,
  quote = "needed",
...
file.copy("C:/Users/lprice5/Downloads/homeroom_counts_for_capping_11-16-2023.csv",
          "O:/Transfer Files/Data_Output_2023-24/PreK Seats Dashboard/1 Source Files/homeroom_counts_for_capping_11-16-2023.csv", overwrite = TRUE, copy.date = TRUE)

cap0today = read_csv("O:/Transfer Files/Data_Output_2023-24/PreK Seats Dashboard/1 Source Files/homeroom_counts_for_capping_11-16-2023.csv") |> as_tibble() |>
...
write_excel_csv(cappingButNotMsched,
  paste0(print_wd,"2023_1117_cappingButNotMsched.csv"),
  na = "",
  append = FALSE,
  col_names = TRUE,
  quote = "needed",
